...
?>
	...
	@product-option [data-v-poption-product_option_id]|before = <?php $selected = $poption['option_id'] ?? false;?>
	@product-option [data-v-poption-required]|addNewAttribute = <?php if ($poption['required'] == '1') echo 'checked';?>
	
	@product-option a[data-v-poption-product_option_id]|href = <?php echo '#' . $poption['product_option_id'];?>
	@product-option div[data-v-poption-product_option_id]|id = <?php echo $poption['product_option_id'];?>
	...
	[data-v-product] [data-v-product-poption] div[data-v-poption]|id = <?php echo $poption['product_option_id'];?>
...
@option|before = <?php
//var_dump($this->product['option_value_content']);
