-- Products
	...
	BEGIN
		...
		@EACH(:product_variant) 
			...
			-- ON DUPLICATE KEY UPDATE product_variant_id = :each;
	...
	BEGIN
		...
		@EACH(:product_subscription) 
			...
			-- ON DUPLICATE KEY UPDATE subscription_plan_id = :each;
	...
	BEGIN
		...
		@EACH(:product_discount) 
			...
			-- ON DUPLICATE KEY UPDATE discount_plan_id = :each;
	...
	BEGIN
		...
		@EACH(:product_promotion) 
			...
			-- ON DUPLICATE KEY UPDATE promotion_plan_id = :each;
	...
	BEGIN
		...
		@EACH(:product_points) 
			...
			-- ON DUPLICATE KEY UPDATE points_plan_id = :each;
	...
	BEGIN
		...
		@EACH(:product_attribute) 
			...
			-- ON DUPLICATE KEY UPDATE attribute_plan_id = :each;
