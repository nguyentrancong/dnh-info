-- Returns
	...
	BEGIN
		-- return
		SELECT return.*, return_action.name as return_action, return_reason.name as return_reason, return_status.name as return_status
			FROM return AS return
			INNER JOIN return_action ON return_action.return_action_id = return.return_action_id AND return_action.language_id = :language_id
